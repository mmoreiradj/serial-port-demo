...
impl CloudletMessage {
    pub fn new(message_type: u16, content: String) -> CloudletMessage {
...
impl CloudletProtocol {
    ...
    pub fn send_message(&mut self, message: CloudletMessage) {
        ...
        buffer.push((message.message_type >> 8) as u8);
        buffer.push((message.message_type & 0xFF) as u8);
        buffer.extend(message.content.as_bytes());
